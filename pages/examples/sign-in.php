...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Admin<b>VCB</b></a>
            <small>Admin Chicken Based - Voodoo Chicken Bookstore</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST">
                    <div class="msg">Entre com seu Login</div>
                    ...
                    <div class="row">
                        <div class="col-xs-8 p-t-5">
                            ...
                            <label for="rememberme">Lembrar seu Login?</label>
                        </div>
                        <div class="col-xs-4">
