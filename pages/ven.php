...
<body class="theme-black">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="../images/anonimo.jpg" width="120" height="120" alt="User" style="margin-top:-12px;">
                </div>
                <div class="info-container" style="margin-top:-100px; margin-left:140px;">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div style="white-space:normal">
                        Estoquista Dois da Silva
                      </div>
                      <div style="magin-top:-10px"><h6 style="margin:0px;">Estoquista</h6></div>
                      </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2011/04/25</td>
                                            <td>$320,800</td>
                                            <td><button class="btn btn-primary waves-effect" data-type="html-message">Detalhes</button></td>
